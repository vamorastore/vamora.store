...
<a href="#" class="text-blue-500" id="addAddressLink">
...
<div id="addAddressModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full max-h-[90vh] overflow-y-auto font-unbounded">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-xl font-bold" id="addressModalTitle">Add New Address</h3>
            ...
            <div class="checkout-left">
                ...
                <div class="checkout-section">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <button id="checkoutAuthButton" class="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline transition-colors">
                            LOG IN
                        </button>
                    </div>
                    <div class="form-group">
                        <label for="email" class="form-label required-field">Email</label>
                        <input type="email" id="email" class="form-input bg-gray-100" placeholder="your@email.com" required>
                        <div id="email-error" class="error-message" style="display: none;"></div>
                    </div>
                    <div class="form-group mt-4">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" id="news-offers" class="mr-2 h-4 w-4">
                            <span class="text-xs text-gray-600">Email me with news and offers</span>
                        </label>
                    </div>
                </div>
...
<div class="checkout-section">
    ...
    <div class="form-group">
        ...
        <div id="country-error" class="error-message" style="display: none;">This field is required</div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <div id="first-name-error" class="error-message" style="display: none;">This field is required</div>
        </div>
        <div class="form-group">
            ...
            <div id="last-name-error" class="error-message" style="display: none;">This field is required</div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div id="address-error" class="error-message" style="display: none;">This field is required</div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <div id="city-error" class="error-message" style="display: none;">This field is required</div>
        </div>
        <div class="form-group">
        ...
        <option value="Puducherry">Puducherry</option>
            ...
            <div id="state-error" class="error-message" style="display: none;">This field is required</div>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <div id="pin-code-error" class="error-message" style="display: none;">This field is required</div>
        </div>
        <div class="form-group">
            ...
            <div id="phone-error" class="error-message" style="display: none;">This field is required</div>
        </div>
    </div>
