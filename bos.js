...
// Get the checkout auth button element
const checkoutAuthButton = document.getElementById('checkoutAuthButton');

// Function to update the checkout auth button based on auth state
...
// Add event listener for the checkout auth button
if (checkoutAuthButton) {
    checkoutAuthButton.addEventListener('click', function(e) {
        ...
        if (user) {
            ...
            // User is not logged in - show auth container with login
            showAuthContainer();
            showLoginSection();
        }
    });
    ...
    // Add hover effects
    checkoutAuthButton.addEventListener('mouseenter', function() {
        this.classList.add('underline');
    });
    
    checkoutAuthButton.addEventListener('mouseleave', function() {
        this.classList.remove('underline');
    });
    
    // Add click effect
    checkoutAuthButton.addEventListener('mousedown', function() {
        this.classList.add('opacity-75');
    });
    
    checkoutAuthButton.addEventListener('mouseup', function() {
        this.classList.remove('opacity-75');
    });
    
    checkoutAuthButton.addEventListener('mouseout', function() {
        this.classList.remove('opacity-75');
    });
}
